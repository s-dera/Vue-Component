...
var axios = __webpack_require__(31).default;
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['resourceName', 'field'],

    mounted: function mounted() {

        axios.get('/usr').then(function (response) {
            // handle success
...
var render = function() {
  ...
  return _c("div", {
    staticClass: "w-12 form-control form-input form-input-bordered",
    staticStyle: { "background-color": "field.chose" }
  })
}
var staticRenderFns = []
    ...
    [
      _c("template", { slot: "field" }, [
        _c("input", {
          ...
          attrs: { id: _vm.field.name, type: "color" },
